...
사람이 듣기에 좋은 음악을 만들려면 여러가지 작곡법, 화성악 등이 필요한데 이러한 것들을 비전문가가 분석하고 이해하기에는 어려운 점이 있다. 음악의 토대가 되는 코드 진행의 경우 자연어처럼 패턴이 있는 것을 이해하고 이를 word2vec 모델로 치환하여 활용한 것이 참 독특했다. 사실 이러한 아이디어로 몬가 만들어보면 어떨까하다 찾아보던 중, 역시 내가 생각한 건 이미 누군가 생각한 것 중 하나이며, 구글에게 감사하는 마음으로… 
